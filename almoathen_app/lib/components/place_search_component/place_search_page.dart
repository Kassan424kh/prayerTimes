...
import 'package:almoathen_app/components/place_search_component/place_search_banner_field.dart';
      ...
      body: Container(
        child: Column(children: <Widget>[
          ...
          foundedPlaces.getFoundedPlaces().length != 0
              ...
              : Center(child: Text('No searched places', style: TextStyle(color: appStyling.primaryTextColor)))
        ]),
      ),
    );
  }
